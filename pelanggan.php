                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Selamat Datang Silahkan Melakukan Pembayaran</li>
                        </ol>
                        <div class="row">
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="text" name="notelepon" class="form-control mt-2" placeholder="No Telepon" value="<?=$notelepon;?>" >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="notelepon" class="form-control mt-2" placeholder="No Telepon">
