...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="stok.php">KASIR SRC MUTIARA</a>
        <!-- Sidebar Toggle-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Beberapa stok barang yang ada ditoko.</li>
                        </ol>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusdatabarangmasuk"> Yes</button>
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                            </div>
