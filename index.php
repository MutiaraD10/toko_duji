                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    $hitungtotal = mysqli_query($c, "select * from detailpesanan where idpesanan='$idpesanan'");
                                    $total = mysqli_num_rows($hitungtotal);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$total;?></td>
                                            <td>
                                                <a href="view.php?idp=<?=$idpesanan;?>" class="btn btn-primary" target="blank" >View</a> 
